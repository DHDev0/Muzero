...
#         convolution_covert = torch.nn.Conv2d(out_channels, 1,
...
#     def __init__(self, observation_space_dimensions, 
#                  state_dimension, hidden_layer_dimensions, 
...
#         activation = torch.nn.LeakyReLU()
#         resblock = Residual_block(1)
#         linear_layer = nn.Linear(81,81)
...
#                              ]  + \
#                              [flatten] +\
#                              ([linear_layer,activation,linear_layer] * number_of_hidden_layer)
...
#         sequence_layer_init = [nn.Linear(81 + action_dimension, hidden_layer_dimensions),
#                                 activation]
#         sequence_layer_recursive = [nn.Linear(hidden_layer_dimensions, hidden_layer_dimensions),
#                                     activation] * number_of_hidden_layer
#         sequence_layer_out = [nn.Linear(hidden_layer_dimensions, 81)]
        
#         self.sequential_container = nn.Sequential(*tuple(sequence_layer_init + \
...
#         self.sequential_reward = nn.Sequential(*tuple(sequence_layer_init + \
#                                                       sequence_layer_recursive + \
#                                                       sequence_layer_out) )
...
#         sequence_layer_init = [nn.Linear(81, hidden_layer_dimensions),
#                                 activation]
#         sequence_layer_recursive = [nn.Linear(hidden_layer_dimensions, hidden_layer_dimensions),
#                                     activation] * number_of_hidden_layer
#         sequence_layer_out = [nn.Linear(hidden_layer_dimensions, 81)]
        
#         multilayer_perceptron_line = nn.Sequential(*tuple(sequence_layer_init + \
#                                                            sequence_layer_recursive + \
#                                                            sequence_layer_out) )
...
#         sequence_1 = [multilayer_perceptron_line]
#         sequence_2 = [multilayer_perceptron_value]
#         sequence_3 = [multilayer_perceptron_policy]
